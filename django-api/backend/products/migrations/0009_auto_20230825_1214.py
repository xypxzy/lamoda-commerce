...
def create_data(apps, schema_editor):
    ...
    compound3 = Compound.objects.create(name='Алоэ вера')
    compound4 = Compound.objects.create(name='Вода')
    compound5 = Compound.objects.create(name='Гиалуроновая кислота')
    compound6 = Compound.objects.create(name='Салициловая кислота')
    compound7 = Compound.objects.create(name='Глицерин')
    compound8 = Compound.objects.create(name='Витамины В6')
    compound9 = Compound.objects.create(name='Растительные экстракты')
    compound10 = Compound.objects.create(name='Коллаген')
    ...
    for product_item in product_data:
        ...
        random_compounds = sample(list_comps, 3)

        product.categories.set(cats)
        product.compound.set(random_compounds)
