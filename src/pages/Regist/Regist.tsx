  ...
  return (
    <section className={cls.register}>
      <div className={cls.register__container}>
        <Link to={'/'} className={cls.register__logo}><img className="w-20 h-20 mr-2" src={logo} alt="logo"/></Link>
        <div className={cls.register__form_wrap}>
          <div className={cls.register__form_wrapper}>
            <h1 className={cls.register__form_title}>
            ...
            <form className={cls.register__form_forms} action="#">
              ...
              <div>
                ...
                <input
                  ...
                  className={`bg-gray-50 border ${errors.email ? "border-red-500" : "border-gray-300"} ${cls.register__form_input}`}
                  placeholder="name@company.com"
                />
                {errors.email && <p className="text-red-500  text-[12px] mt-1">{errors.email.message}</p>}
              </div>
              <div>
                <label htmlFor="firstName" className={cls.register__form_label}>Имя</label>
                <input
                  type="firstName"
                  id="firstName"
                  placeholder="Alex"
                ...
                />
                {errors.first_name && <p className="text-red-500 text-[12px] mt-1">{errors.first_name.message}</p>}
              </div>
              <div>
                <label htmlFor="lastName" className={cls.register__form_label}>Фамилия</label>
                <input
                  type="lastName"
                  id="lastName"
                  placeholder="Alex"
                ...
                />
                {errors.last_name && <p className="text-red-500 text-[12px] mt-1">{errors.last_name.message}</p>}
              </div>
              <div>
              ...
              <div>
                <label htmlFor="confirm-password" className={cls.register__form_label}>Подтвердить пароль</label>
                <input
                  type="password"
                  id="confirm-password"
                  placeholder="••••••••"
              ...
              <p className={cls.register__form_register__link}>
                ...
                <Link to={'/login'} className={cls.register__form_register__link__text}>Зайти в аккаунт</Link>
              </p>
            </form>
          </div>
        </div>
